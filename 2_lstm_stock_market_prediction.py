"""
Script ini memberikan contoh bagaimana memanfaatkan tensorflow untuk mengimplementasikan model LSTM (Long Short Term Memory) dan menggunakannya untuk prediksi stock market.
...
fname = 'hpq-us-stocks.txt'
df = pd.read_csv(fname),delimiter=',',usecols=['Date','Open','High','Low','Close'])
...
for ep in range(epochs):       
    print("Running at epoch-{} out of {}".format(ep+1, epochs))
